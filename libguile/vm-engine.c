...
#undef INIT
 ...
 apply:
   ...
   */
  VM_DEFINE_OP (13, abort, "abort", OP1 (U8_X24))
    {
   ...
   */
  VM_DEFINE_OP (14, builtin_ref, "builtin-ref", OP1 (U8_U12_U12) | OP_DST)
    {
   ...
   */
  VM_DEFINE_OP (21, alloc_frame, "alloc-frame", OP1 (U8_U24))
    {
   ...
   */
  VM_DEFINE_OP (22, reset_frame, "reset-frame", OP1 (U8_U24))
    {
      scm_t_uint32 nlocals;
      SCM_UNPACK_RTL_24 (op, nlocals);
      RESET_FRAME (nlocals);
   ...
   */
  VM_DEFINE_OP (23, assert_nargs_ee_locals, "assert-nargs-ee/locals", OP1 (U8_U12_U12))
    {
   ...
   */
  VM_DEFINE_OP (24, bind_kwargs, "bind-kwargs", OP4 (U8_U24, U8_U24, X8_U24, N32))
    {
   ...
   * list at DST.
   */
  VM_DEFINE_OP (25, bind_rest, "bind-rest", OP1 (U8_U24) | OP_DST)
    {
   ...
   * 24-bit number, to the current instruction pointer.
   */
  VM_DEFINE_OP (37, br_if_ee, "br-if-=", OP2 (U8_U12_U12, B1_X7_L24))
    {
   ...
   * 24-bit number, to the current instruction pointer.
   */
  VM_DEFINE_OP (38, br_if_lt, "br-if-<", OP2 (U8_U12_U12, B1_X7_L24))
    {
   ...
   * 24-bit number, to the current instruction pointer.
   */
  VM_DEFINE_OP (39, br_if_le, "br-if-<=", OP2 (U8_U12_U12, B1_X7_L24))
    {
   ...
   * actually bound.
   */
  VM_DEFINE_OP (43, box_ref, "box-ref", OP1 (U8_U12_U12) | OP_DST)
    {
      scm_t_uint16 dst, src;
      SCM var;
      SCM_UNPACK_RTL_12_12 (op, dst, src);
   ...
   */
  VM_DEFINE_OP (44, box_set, "box-set!", OP1 (U8_U12_U12))
    {
      scm_t_uint16 dst, src;
      SCM var;
      SCM_UNPACK_RTL_12_12 (op, dst, src);
   ...
   * allocated.
   */
  VM_DEFINE_OP (45, make_closure, "make-closure", OP3 (U8_U24, L32, X8_U24) | OP_DST)
    {
   ...
   */
  VM_DEFINE_OP (46, free_ref, "free-ref", OP2 (U8_U12_U12, X8_U24) | OP_DST)
    {
      scm_t_uint16 dst, src;
      scm_t_uint32 idx;
      SCM_UNPACK_RTL_12_12 (op, dst, src);
   ...
   */
  VM_DEFINE_OP (47, free_set, "free-set!", OP2 (U8_U12_U12, X8_U24))
    {
      scm_t_uint16 dst, src;
      scm_t_uint32 idx;
      SCM_UNPACK_RTL_12_12 (op, dst, src);
   ...
   * 0.
   */
  VM_DEFINE_OP (48, make_short_immediate, "make-short-immediate", OP1 (U8_U8_I16) | OP_DST)
    {
      scm_t_uint8 dst;
      scm_t_bits val;
   ...
   * 0.
   */
  VM_DEFINE_OP (49, make_long_immediate, "make-long-immediate", OP2 (U8_U24, I32))
    {
      scm_t_uint8 dst;
      scm_t_bits val;
   ...
   */
  VM_DEFINE_OP (50, make_long_long_immediate, "make-long-long-immediate", OP3 (U8_U24, A32, B32) | OP_DST)
    {
      scm_t_uint8 dst;
      scm_t_bits val;
   ...
   */
  VM_DEFINE_OP (51, make_non_immediate, "make-non-immediate", OP2 (U8_U24, N32) | OP_DST)
    {
      scm_t_uint32 dst;
      scm_t_int32 offset;
      scm_t_uint32* loc;
   ...
   */
  VM_DEFINE_OP (52, static_ref, "static-ref", OP2 (U8_U24, S32))
    {
      scm_t_uint32 dst;
      scm_t_int32 offset;
      scm_t_uint32* loc;
   ...
   */
  VM_DEFINE_OP (53, static_set, "static-set!", OP2 (U8_U24, LO32))
    {
      scm_t_uint32 src;
      scm_t_int32 offset;
      scm_t_uint32* loc;
   ...
   * signed value.
   */
  VM_DEFINE_OP (54, link_procedure, "link-procedure!", OP2 (U8_U24, L32))
    {
      scm_t_uint32 src;
      scm_t_int32 offset;
      scm_t_uint32* loc;
   ...
   */
  VM_DEFINE_OP (55, current_module, "current-module", OP1 (U8_U24) | OP_DST)
    {
      scm_t_uint32 dst;
   ...
   */
  VM_DEFINE_OP (57, define, "define", OP1 (U8_U12_U12))
    {
   ...
   * time.
   */
  VM_DEFINE_OP (58, toplevel_box, "toplevel-box", OP5 (U8_U24, S32, S32, N32, B1_X31) | OP_DST)
    {
      scm_t_uint32 dst;
   ...
   */
  VM_DEFINE_OP (59, module_box, "module-box", OP5 (U8_U24, S32, N32, N32, B1_X31) | OP_DST)
    {
      scm_t_uint32 dst;
      scm_t_int32 var_offset;
      scm_t_uint32* var_loc_u32;
   ...
   */
  VM_DEFINE_OP (60, prompt, "prompt", OP3 (U8_U24, B1_X7_U24, X8_L24))
    {
   ...
   */
  VM_DEFINE_OP (61, wind, "wind", OP1 (U8_U12_U12))
    {
   ...
   */
  VM_DEFINE_OP (63, push_fluid, "push-fluid", OP1 (U8_U12_U12))
    {
   ...
   */
  VM_DEFINE_OP (64, pop_fluid, "pop-fluid", OP1 (U8_X24))
    {
