...
#define SCM_RTL_PROGRAM_META_OFFSET(x) ((scm_t_ptrdiff) (SCM_RTL_PROGRAM_CODE (x)[1]))
#define SCM_RTL_PROGRAM_META(x) (SCM_RTL_PROGRAM_CODE (x) + SCM_RTL_PROGRAM_META_OFFSET (x))
